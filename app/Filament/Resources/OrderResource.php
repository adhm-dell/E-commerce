                    ...
                    Section::make('Order Items')->schema([
                        Repeater::make('items')
                            ...
                            ->schema([
                                ...
                                TextInput::make('quantity')->required()->numeric()->default(1)->minValue(1)->columnSpan(2)->reactive()->afterStateUpdated(fn($state, Set $set, Get $get) => $set('total_amount', $get('unit_amount') * $state)),
                        ...
                        Placeholder::make('grand_total_placeholder')->columnSpanFull()
                            ->label('Grand Total')
